...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public NoteViewHolder(@NonNull View itemView, NoteOperator operator) {
        ...
        claText=itemView.findViewById(R.id.text_cla);
    ...
    public void bind(final Note note) {
        ...
        claText.setText(String.valueOf(note.getCla()));
        ...
        String color = claText.getText().toString();
        switch (color) {
            case "1":
                itemView.setBackgroundColor(0xffcc0000);
                itemView.getBackground().setAlpha(100);
                break;
            case "2":
                itemView.setBackgroundColor(0xffff8800);
                itemView.getBackground().setAlpha(100);
                break;
            case "3":
                itemView.setBackgroundColor(0xffffbb33);
                itemView.getBackground().setAlpha(100);
                break;
            case "4":
                itemView.setBackgroundColor(0xff99cc00);
                itemView.getBackground().setAlpha(100);
                break;
            default:
                itemView.setBackgroundColor(0xff669900);
                itemView.getBackground().setAlpha(100);
                break;
        }
    }
